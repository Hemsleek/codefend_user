        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form class="w-full max-w-md">
                ...
                <div class="relative flex items-center mt-4">
                    ...
                    <input type="password" onChange={(e) => {setPassword(e.target.value)}} class="block w-full py-3 bg-white border rounded px-11 log-inputs dark:text-gray-300" placeholder="Password"></input>
                </div>

                <div class="mt-6">
                    <button onClick={(e) => {handleSubmit(e)}} class="bg-codefend w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 rounded">
                        Sign in
                    </button>

                    <div class="mt-6 text-center ">
                        <a href="#" onClick={() => {history.push('/auth/signup')}} class="text-sm codefend-text-red hover:underline">
